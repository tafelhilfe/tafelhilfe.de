  ...
  <div class="content container">
    <div class="mx-auto py-6">
      <div class="px-4 py-4">
        ...
        <p class="paragraph">In Folge der COVID-19 Pandemie haben sich weltweit gesellschaftliche Probleme ergeben, für die es während des 48-Stunden-Hackathons galt, Lösungskonzepte zu finden.</p>
        <p class="paragraph">
