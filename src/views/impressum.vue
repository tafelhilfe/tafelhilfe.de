  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-4 sm:px-0">
        <h1 class="text-4xl">Legal Disclosure</h1>
        ...
        74821 Mosbach
        <br />
        <h2 class="text-3xl">Contact Information</h2>
        Telephone: 0151/25896169
        <br />
        E-Mail:
        <a class="underline text-highlight" href="mailto:kontakt@lgastler.de">
          kontakt@lgastler.de
        </a>
        <br />
        Internet address:
        <router-link class="underline text-highlight" to="/" target="_blank">
          www.lennartgastler.de
        </router-link>
        <br />
        <br />
        <h2 class="text-3xl">Disclaimer</h2>
        <h3 class="text-xl">Accountability for content</h3>
        <br />
        ...
        <br />
        <br />
        <h3 class="text-xl">Accountability for links</h3>
        <br />
